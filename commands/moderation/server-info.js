...
module.exports = {
    ...
    async execute (client, message, args) {
        ...
        let welcome = message.guild.channels.cache.get(serverSettings.welcomeChannelID);
        let sugestion = message.guild.channels.cache.get(serverSettings.sugestionChannelID);
